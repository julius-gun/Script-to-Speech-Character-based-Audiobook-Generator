const translations = {
    en: {
        ...
        promptRule2: "2. For any sentence spoken by a specific character (dialogue), insert a concise marker at the very beginning of that sentence.",
        promptRule3: "3. The marker MUST be in this format: `[Character Name, gender]:` (e.g. `[Max, m]:` for male or `[Sarah, f]:` for female).",
